...
import { Ticket, TicketType, TicketStatus, Severity } from '../../types';
...
const HelpdeskDashboard: React.FC<HelpdeskDashboardProps> = ({ tickets, onCreateTicket, onNavigateToTicket, onViewAllTickets }) => {
